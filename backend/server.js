...
app.use(process.env.product_category_image_path_name, express.static(process.env.product_category_image_path));
app.use(process.env.product_image_path_name, express.static(process.env.product_image_path));
...
// ✅ Trust the reverse proxy (like Apache or Nginx)
...
app.listen(port, async () => {
    console.log(`Product Operation backend running port ${port}`);
});