...
const queries = require('../queries/product-review');


let databaseColum = [{"name":"id","type":"bigint"},{"name":"product_id","type":"bigint"},{"name":"user_id","type":"bigint"},{"name":"name","type":"varchar"},{"name":"rating","type":"decimal"},{"name":"comment","type":"text"},{"name":"status","type":"int"}];
let jsonColum = [];
// Promises Method
