...
const queries = require('../queries/product-highlight');


let databaseColum = [{ "name": "id", "type": "bigint" }, { "name": "product_id", "type": "bigint" }, { "name": "highlight", "type": "text" }, { "name": "status", "type": "int" }];
let jsonColum = [];
// Promises Method
