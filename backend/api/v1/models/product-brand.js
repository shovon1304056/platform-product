...
const queries = require('../queries/product-brand');


let databaseColum = [{"name":"id","type":"bigint"},{"name":"name","type":"varchar"},{"name":"logo_public_id","type":"varchar"},{"name":"logo_url","type":"text"},{"name":"status","type":"int"}];
let jsonColum = [];
